...
import com.example.demoredis.util.RedisService;
 ...
 * @Description: https://github.com/JayTange/springbootRedis/blob/master/src/test/java/com/config/RedisConfigTest.java
 */
...
public class RedisConfigTest {
    ...
    public void testObj() throws Exception{
        ...
        operations.set("name","test20m");
        redisService.expireKey("name",20, TimeUnit.SECONDS);
        Object o = operations.get("name");
